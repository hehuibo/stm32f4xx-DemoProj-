...
void AppTaskInit(void){
  ...
  InitBoardPeripheral(); 
#if 1 
  LcdPutStr("液晶显示1", sizeof("液晶显示"), eLcdWRCtrlLine_One, 0);
  LcdPutStr("液晶显示2", sizeof("液晶显示"), eLcdWRCtrlLine_Two, 0);
  LcdPutStr("液晶显示3", sizeof("液晶显示"), eLcdWRCtrlLine_Three, 0);
  LcdPutStr("液晶显示4", sizeof("液晶显示"), eLcdWRCtrlLine_Four, 0);  
#endif
}
