...
#define PBUF_POOL_SIZE          20//11

/* PBUF_POOL_BUFSIZE: the size of each pbuf in the pbuf pool. */
#define PBUF_POOL_BUFSIZE       LWIP_MEM_ALIGN_SIZE((TCP_MSS+44+PBUF_LINK_HLEN))
...
#else
#define TCP_MSS                 128//256//(1500 - 40)/* TCP_MSS = (Ethernet MTU - IP header size - TCP header size) */
#endif

/* TCP sender buffer space (bytes). */
#define TCP_SND_BUF             (4*TCP_MSS)	//((MEM_SIZE / TCP_MSS - 1) * TCP_MSS)//(5*TCP_MSS)
